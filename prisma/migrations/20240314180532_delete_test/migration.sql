/*
  ...
  - You are about to drop the column `test` on the `ForumAccount` table. All the data in the column will be lost.
...
INSERT INTO "new_ForumAccount" ("active", "createdAt", "createdId", "id", "lastCheck", "login", "password", "sid") SELECT "active", "createdAt", "createdId", "id", "lastCheck", "login", "password", "sid" FROM "ForumAccount";
